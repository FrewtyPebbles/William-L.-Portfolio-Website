    ...
    <div className="min-h-full w-full flex flex-col justify-center">
      <div className="my-20">
        <h1 className="text-5xl font-extralight text-right p-10 bg-radial 
            dark:from-white dark:to-white/80 dark:text-black
            from-black to-black/80 text-white">
        ...
        <div className="">
          <div className="p-10">
            <div className='float-right max-sm:max-w-full max-w-[50%] sm:ml-10 mb-10 z-0 transition-all duration-500'>
              <img className='mask-b-from-90% sm:mask-l-from-90% mask-t-from-99% mask-r-from-99% mask-l-from-99% max-h-[700px]' src="/static/7bbb6f2a-f00e-4005-8a19-17c318c0691b.jpg" alt="profile" />
